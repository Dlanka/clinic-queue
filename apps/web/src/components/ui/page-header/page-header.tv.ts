...
export const pageHeaderStyles = tv({
  slots: {
    root: "relative overflow-hidden rounded-xl bg-neutral-30 border border-subtle g-linear g-linear-primary",
    header: "flex items-center gap-4 border-b border-subtle px-6 py-5",
